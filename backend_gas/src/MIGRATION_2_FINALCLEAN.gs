var PHBOX_M2_FINALCLEAN_VERSION_ = 'M2_FINALCLEAN_v3';
...
function runMigration2FinalCleanSelfTest_() {
  var cases = [
    ...
    {
      id: 'actual_legacy_settings_handler_names_block_finalclean',
      result: buildMigration2FinalCleanResult_({
        costStatus: buildMigration2FinalCleanSyntheticCostStatus_({}),
        obsoleteHandlers: [
          'runMigration1FreezeBaselineSettingsTest',
          'getMigration1FreezeBaselineSettingsStatus',
          'runMigration1DocumentationSettingsTest',
