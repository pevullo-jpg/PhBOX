...
6. Verificare che il resolver non venga collegato a publish target prima di M1-PUB.
7. Verificare che non siano presenti nella Settings UI i preset test M1-SHADOW già chiusi.
