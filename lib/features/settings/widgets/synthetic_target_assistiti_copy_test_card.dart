...
class _SyntheticTargetAssistitiCopyTestCardState
  ...
  Widget build(BuildContext context) {
    return SettingsFieldCard(
      ...
      subtitle:
          'Copia manuale bounded di 3 assistiti sintetici per verificare normalizzazione nome/cognome, medico sintetico e struttura target. Non usa dati reali, non legge legacy e non crea famiglie operative.',
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          const Text(
            'Dataset: famiglia sintetica syn_family_0001 · assistitoId opachi syn_assistito_0001/0002/0003 · medico sintetico Dott.ssa Elena Ferri. Scrive solo su tenants/{tenantId}/assistiti dopo conferma manuale.',
            style: TextStyle(
