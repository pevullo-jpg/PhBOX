...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void _removeRecipeFromCachedSummary(_PatientDashboardSummary summary, DrivePdfImport removedImport) {
    ...
    final int nextImportDpcCount = nextImports.where((DrivePdfImport item) => item.isDpc).length;
    final int nextLegacyDpcCount = summary.prescriptions.where((Prescription item) => item.dpcFlag).length;
    final int nextDpcCount = nextImportDpcCount + nextLegacyDpcCount;
