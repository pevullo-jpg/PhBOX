...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void _removeRecipeFromCachedSummary(_PatientDashboardSummary summary, DrivePdfImport removedImport) {
    ...
    final List<Prescription> nextPrescriptions = summary.prescriptions
        ...
        .toList();
    final int nextRecipeCount = PhboxContractUtils.resolveDashboardRecipeCount(
      allImports: previousImports,
      visibleImports: nextImports,
      legacyPrescriptions: nextPrescriptions,
    );
    final int nextDpcCount = PhboxContractUtils.resolveDashboardDpcCount(
      allImports: previousImports,
      visibleImports: nextImports,
      legacyPrescriptions: nextPrescriptions,
    );
    final bool nextHasExpiryAlert = PhboxContractUtils.resolveDashboardHasExpiryAlert(
      allImports: previousImports,
      visibleImports: nextImports,
      legacyPrescriptions: nextPrescriptions,
      isExpiryAlert: _DashboardTotals._isExpiryAlert,
    );
  ...
  Future<void> _deletePatientEverything(_PatientDashboardSummary summary) async {
    ...
    try {
      ...
      await _replaceCachedSummaryAwaitingIndex(
        summary.copyWith(
          imports: const <DrivePdfImport>[],
          prescriptions: const <Prescription>[],
          debts: const <Debt>[],
