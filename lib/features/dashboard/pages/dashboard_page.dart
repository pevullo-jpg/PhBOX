              ...
              if (savedAdvances.isNotEmpty) {
                try {
                  ...
                  if (dialogContext.mounted) {
                    setLocalState(() {
                      busy = false;
                      localError = 'Anticipi parzialmente salvati (${savedAdvances.length}/${advances.length}), ma indice/totali non riallineati: $reconcileError. Verifica prima di reinserire.';
                    });
                  }
                }
                return;
