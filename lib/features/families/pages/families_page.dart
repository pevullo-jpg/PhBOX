              ...
              actions: [
                ...
                FilledButton(
                  onPressed: () async {
                    ...
                    try {
                      final Set<String> previousMembers = _normalizedUniqueFamilyMemberCodes(initial?.memberFiscalCodes ?? const <String>[]).toSet();
                      ...
                      syncMessage = 'Famiglia salvata. Badge Home non riallineati: $e';
                    }
