...
class TenantSession {
  ...
  factory TenantSession.fromTenantAccess(TenantAccess tenantAccess) {
    return TenantSession(
      tenantId: tenantAccess.tenantId,
      tenantName: tenantAccess.tenantName,
      loginEmail: tenantAccess.loginEmail,
      schemaVersion: tenantAccess.schemaVersion,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(tenantId, tenantName, loginEmail, schemaVersion);
}
...
class TenantSessionScope extends InheritedWidget {
  ...
  static TenantSession of(BuildContext context) {
    ...
    assert(session != null, 'TenantSessionScope not found in context.');
    return session!;
  }

  @override
  bool updateShouldNotify(covariant TenantSessionScope oldWidget) {
