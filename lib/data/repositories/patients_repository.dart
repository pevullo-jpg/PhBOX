...
class PatientsRepository {
  ...
  Future<PatientProfileUpdateResult> _migrateTemporaryPatientToFiscalCodeDirect({
    ...
    final DocumentSnapshot<Map<String, dynamic>> newPatientSnap = await newPatientRef.get();
    ...
    void migrateSubcollectionDocs(
      ...
      for (final QueryDocumentSnapshot<Map<String, dynamic>> doc in docs) {
        ...
        batch.set(newPatientRef.collection(subcollection).doc(doc.id), data);
    ...
    if (oldIndexSnap.exists && oldIndexSnap.data() != null) {
      ...
      batch.set(newIndexRef, indexData);
    ...
    if (oldAdviceSnap.exists && oldAdviceSnap.data() != null) {
      ...
      batch.set(newAdviceRef, adviceData);
