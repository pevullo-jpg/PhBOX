...
class RealAssistitiMigration1DataReportItem {
  ...
  bool get resolvedManual => identityResolutionStatus == RealAssistitiMigration1DataReportReader.resolvedManualStatus;

  bool get pendingManual => identityResolutionStatus == RealAssistitiMigration1DataReportReader.pendingManualStatus;
...
class RealAssistitiMigration1DataReportReader {
  ...
  static RealAssistitiMigration1DataReportResult buildReportFromRawDocuments({
    ...
    final List<RealAssistitiMigration1DataReportRawDocument> rawDocuments =
        _collectBoundedRawDocuments(documents);
  ...
  static List<RealAssistitiMigration1DataReportRawDocument> _collectBoundedRawDocuments(
  ...
  static List<String> _readStringList(Object? value) {
    ...
    return List<String>.unmodifiable(
      value.map((Object? item) => _readString(item)).where((String item) => item.isNotEmpty),
    );
  }
