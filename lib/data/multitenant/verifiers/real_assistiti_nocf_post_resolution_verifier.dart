...
class RealAssistitiNoCfPostResolutionVerifier {
  ...
  static bool _hasAcceptedResolutionState({
    ...
    final bool statusAccepted = rootStatus == resolvedManualStatus ||
        rootStatus == pendingManualStatus ||
        nestedStatus == resolvedManualStatus ||
        nestedStatus == pendingManualStatus;
    final bool confidenceAccepted = nameSplitConfidence == resolvedManualConfidence ||
        nameSplitConfidence == pendingManualConfidence;
    return statusAccepted && confidenceAccepted;
  }
