...
class RealAssistitiPostCopyVerifier {
  ...
  RealAssistitiPostCopyVerificationItem _buildVerificationItem({
    ...
    if (_readString(cfLockRead.rawData['assistitoPath']) != writtenDocument.documentPath) {
