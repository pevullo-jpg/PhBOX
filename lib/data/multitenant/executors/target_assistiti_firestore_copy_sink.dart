...
class TargetAssistitiFirestoreCopySink implements TargetWriteCommitSink {
  ...
  int get writesRemaining => maxWritesPerInstance - _writesCommitted;
  ...
  void _guardRemainingWrites(String path) {
    if (_writesCommitted >= maxWritesPerInstance) {
      throw TargetAssistitiFirestoreCopyRejectedException(
