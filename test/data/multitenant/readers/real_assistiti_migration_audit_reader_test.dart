...
void main() {
  group('RealAssistitiMigrationAuditResult', () {
    test('aggregates mutually exclusive statuses and readable diagnostics', () {
      ...
      final Map<String, dynamic> alreadyTargetItem =
          (mapped['items'] as List<dynamic>)[1] as Map<String, dynamic>;
      expect((alreadyTargetItem['diagnostics'] as List<dynamic>).single, isA<Map<String, dynamic>>());
      expect(
        ((alreadyTargetItem['diagnostics'] as List<dynamic>).single as Map<String, dynamic>)['code'],
        'already_target',
      );
      expect(
        ((alreadyTargetItem['diagnostics'] as List<dynamic>).single
                as Map<String, dynamic>)['operatorActionRequired'],
        isFalse,
      );
    });
