...
void main() {
  group('RealAssistitiMigrationAuditResult', () {
    test('aggregates copyable, blocked and already-target items without raw payload expansion', () {
      ...
      expect(audit.summary.blockingReasonCounts['target_cf_duplicate'], 1);
    ...
    test('marks target duplicate as already_target status', () {
      final DateTime now = DateTime.utc(2026, 5, 26, 9, 0, 0);
