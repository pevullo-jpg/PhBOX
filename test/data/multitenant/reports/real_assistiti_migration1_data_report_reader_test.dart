...
void main() {
  group('RealAssistitiMigration1DataReportReader', () {
    ...
    test('enforces raw document hard cap without Firestore queries', () {
    ...
    test('enforces raw document hard cap before exhausting lazy input', () {
      int yielded = 0;
      final Iterable<RealAssistitiMigration1DataReportRawDocument> documents =
          _lazyCfDocuments(
        count: 1000,
        onYield: () {
          yielded++;
      ...
      expect(yielded, RealAssistitiMigration1DataReportReader.maxInputDocuments + 1);
    });
  });
}


Iterable<RealAssistitiMigration1DataReportRawDocument> _lazyCfDocuments({
  required int count,
  required void Function() onYield,
}) sync* {
